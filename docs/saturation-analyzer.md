...
- Background fetching and caching for improved performance
...
metricsCollector := controller.NewMetricsCollector(promAPI)
...
capacityTargets := analyzer.CalculateSaturationTargets(analysis, variantStates)

log.Printf("Saturation targets: %+v", capacityTargets)
...
for _, decision := range decisions {
    ...
    log.Printf("  Saturation target: %d", capacityTargets[decision.VariantName])
